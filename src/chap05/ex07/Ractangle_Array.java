...
public class Ractangle_Array {
	...
	public static void main(String[] args) {
	   ...
	   int[][] arr5 = new int [][] { {1,2,3,4,5}, {10, 20 , 30, 40 ,50}, {100, 200, 300, 400, 500}}; //★ [][] 값 바로넣을때 오류 발생
	   ...
	   System.out.println(arr5[1][4]);   //50
		...
		System.out.println(arr6[0][2]); // 0번행 2번열 숫자 //3
	...
	//	System.out.println(Arrays.toString(arr6[3])); 3번행 찍을시 오류 발생 배열의 방번호[intdex]를 넘겨짐

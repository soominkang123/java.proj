...
public class Array_Defintion {
	...
	public static void main(String[] args) {
		...
		// 1. 배열 선언 - 1    :  배열 변수 선언 과 동시에 방의 크기 지정
		    // 자료형[]
		...
		// 3. 배열 선언 - 3 <==== 배열 선언과 동시에 값을 할당. < == 주의 : 방크기를 지정하면 안됨 
		int[] arr5 = new int[] {10 , 20 , 30 , 40 , 50} ; //[]안에 숫자 넣지 않고 할당
		...
		System.out.println("========================");
		int[] arr6;      //  0    1     2    3      4     5     6   // 배열 변수 선언
		...
		int[] arr8 ;
	//	arr8 = { 66, 77 , 88 , 99} ;  // new int[] 삽입안할시 오류 발생
		...
		String [] arr9 = {"아버님" , "어머님" , "형제" , "동생"} ;
		 ...
		 //출력
		 for ( int i = 0 ; i < arr9.length ; i ++) { // arr9 legth : 방의 갯수

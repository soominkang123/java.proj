...
public class ConsoleOutPut1 {  // 클래스 블락
	public static void main(String[] args) { // 메인 메소드 블락 : 클래스 블락 내부
		...
		//1. System.outprintln (); 콘솔에 출력후 라인을 개행
		
		    // 문자열을 출력 : "출력할 문자열" 
		System.out.println("안녕하세요");
		
		  // 문자열을 연결해서 출력 :   +  : 정수 , 실수 일때는 덧샘
		                      //   +  : 문자열일때는 연결의 뜻함.
		  System.out.println("안녕하세요" + " 반갑습니다.");
		  		  
		  //정수, 실수일때 : + (덧샘)
		  System.out.println(2+3);  // 정수 를 덧샘
		  System.out.println("2"+"3");   // 문자열 을 연결
		 
		  //실수 출력
		  System.out.println(10.5 + 20.11); // 실수 덧샘
          System.out.println("10.5" + 20.11); // 문자열 + 실수 : 연결	
          ...
          //      =     <== 같다 라는 의미가 아님 , 왼쪽의 변수에 오른쪽의 값을 할당해라
		...
		//3. System. out printf(); : 콘솔에 출력 : 출력 문자열 라인의 변수 값을 불러 오도록 함.
             ...
             //printf(); 를 출력
             System.out.printf("%s %s %s 정수의 값음 : %d", str1, str2, str3, d);
             System.out.println();
             
             //println(); 를 출력
             System.out.println(str1 + str2 +str3 + "정수의 값은 : " + d);
	}
//  System out.println(Helloworld");  <==오류 발생 ,       
}

...
public class UsingScanner {
	...
	public static void main(String[] args) {
		...
		//외부의 라이브라리 사용 하기 : 자바에서 만들어진 클래스의 묶음을 라이브러리
		...
		/* Scanner : 콘솔로 부터 입력 값을 받아오는 클래스 (객체)
		         ...
		         - 동일한 패키지에 존재는 클래스는 import 없이 사용가능 , 
		         - 동일한 패키지에 존재하지 않는 클래스는 import
		         - java.util.Scanner : 클래스의 전체이름 : 패키지명.클래스명
		         - ctrl + shift + o : 자동으로 import 
		         - 콘솔에서 값을 넣고 Enter / 공백를 넣으면, 다음 스캐너에서 입력 대기 
		         
		 */
		          
		// 스캐너 객체 생성
		//참조타입  객체변수명(sc) = new (힙에 객체의 값을 저장하겠다.
		...
		fName = sc.next();  // sc.next(); : 콘솔로 부터 "문자열" 을 인풋 받음 , 콘솔에서 input을 대기

...
public class Array_vs_ArrayList {
	...
	public static void main(String[] args) {
       ...
       // 배열 : 참조 자료형
		...
		System.out.println("배열(arr)에 저장된 10의 배수:");
		System.out.println(Arrays.toString(arr));
		
	    ArrayList<Integer> aList = new ArrayList<>();   // ctrl shift o 
	    
	    for( int i = 20; i<= 100; i+=20) {
	    	aList.add(i);
	        }
	    
	    System.out.println("\nArrayList(aList)에 저장된 20의 배수 :");
	       for (int num : aList) {
	   ...
	   //  배열 각방에 값을 넣기
	    ...
	    /* 출력
	     for(int i = 0 ; i <arr.length ; i++ ) {
	      ...
	      //컬렉션 : AttayList , 자동으로 방크기가 늘어나고 줄어든다. 제너릭 타입으로 선언 : <Integer> 
	       // import 해서 사용
	       // ArrayList 선언
	       ...
	       // aList.get(index)    //index 값을 출력 
	        
	       List<Integer> aList = new ArrayList<>();         //
	       ArrayList<Integer> aList2 = new AttayList<>();
